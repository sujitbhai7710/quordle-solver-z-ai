/* @ts-self-types="./quordle_solver.d.ts" */

export class QuordleSolver {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        QuordleSolverFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    computePattern(guess, answer) {
        ...
        const ptr1 = passStringToWasm0(answer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.quordlesolver_computePattern(this.__wbg_ptr, ptr0, len0, ptr1, len1);
     ...
     * @returns {string[]}
     */
    filterByPattern(words, guess, pattern) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(pattern, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.quordlesolver_filterByPattern(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
    ...
    /**
     * @param {string[]} answer_list
     * @param {string[]} allowed_list
     */
    constructor(answer_list, allowed_list) {
        const ptr0 = passArrayJsValueToWasm0(answer_list, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(allowed_list, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.quordlesolver_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
        QuordleSolverFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) QuordleSolver.prototype[Symbol.dispose] = QuordleSolver.prototype.free;
 ...
 * @returns {string}
 */
export function get_pattern_string(guess, answer) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(guess, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(answer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.get_pattern_string(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./quordle_solver_bg.js": import0,
    };
}

const QuordleSolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_quordlesolver_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('quordle_solver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
